...
class Games(commands.Cog):
    ...
    async def truth(self, ctx, rating: str = None):
        ...
        data = requests.get(
            ...
            f'https://api.truthordarebot.xyz/v1/truth').json()
        ...
        embed.set_author(name='Truth', icon_url=ctx.author.avatar or ctx.author.default_avatar)
    ...
    async def dare(self, ctx, rating: str = None):
        ...
        data = requests.get(
            ...
            f'https://api.truthordarebot.xyz/v1/dare').json()
        embed = discord.Embed(title=f'{data["question"]}', colour=discord.Colour.random())
        embed.set_footer(text=f'Type: {data["type"]} | Rating: {data["rating"].upper()} | ID: {data["id"]}')
        embed.set_author(name='Dare', icon_url=ctx.author.avatar or ctx.author.default_avatar)
    ...
    async def truthordare(self, ctx, rating: str = None, truthordare: str = None):
        ...
        data = requests.get(
            ...
            f'https://api.truthordarebot.xyz/v1/{truthordare}').json()
        embed = discord.Embed(title=f'{data["question"]}', colour=discord.Colour.random())
        embed.set_footer(text=f'Type: {data["type"]} | Rating: {data["rating"].upper()} | ID: {data["id"]}')
        embed.set_author(name='Truth or Dare', icon_url=ctx.author.avatar or ctx.author.default_avatar)
    ...
    async def wouldyourather(self, ctx, rating: str = None):
        ...
        data = requests.get(
            ...
            f'https://api.truthordarebot.xyz/v1/wyr').json()
        embed = discord.Embed(title=f'{data["question"]}', colour=discord.Colour.random())
        embed.set_footer(text=f'Type: {data["type"]} | Rating: {data["rating"].upper()} | ID: {data["id"]}')
        embed.set_author(name='Would You Rather', icon_url=ctx.author.avatar or ctx.author.default_avatar)
    ...
    async def neverhaveiever(self, ctx, rating: str = None):
        ...
        data = requests.get(
            ...
            f'https://api.truthordarebot.xyz/v1/nhie').json()
        embed = discord.Embed(title=f'{data["question"]}', colour=discord.Colour.random())
        embed.set_footer(text=f'Type: {data["type"]} | Rating: {data["rating"].upper()} | ID: {data["id"]}')
        embed.set_author(name='Never Have I Ever', icon_url=ctx.author.avatar or ctx.author.default_avatar)
    ...
    async def paranoia(self, ctx, rating: str = None):
        ...
        embed = discord.Embed(title=f'{data["question"]}', colour=discord.Colour.random())
        embed.set_footer(text=f'Type: {data["type"]} | Rating: {data["rating"].upper()} | ID: {data["id"]}')
        embed.set_author(name='Paranoia', icon_url=ctx.author.avatar or ctx.author.default_avatar)
    ...
    async def tictactoe(self, ctx, member: discord.Member):
        ...
        turn = random.choice([ctx.author, member])
        first_turn = turn
