...
class Moderation(commands.Cog):
    ...
    async def ban(self, ctx, member: discord.Member, *, reason='no reason'):
        try:
            ...
            embed.add_field(name=f'Error in banning {member}',
                            value=f'You or I may not have the permission to ban {member}')
            embed.set_author(name=self.bot.user.name, icon_url=self.bot.user.avatar)
            await ctx.send(embed=embed)
    ...
    async def kick(self, ctx, member: discord.Member, *, reason='no reason'):
        try:
            ...
            embed = discord.Embed(colour=discord.Colour.red())
            embed.add_field(name=f'Error in kicking {member}',
                            value=f'You or I may not have the permission to kick {member}')
            embed.set_author(name=self.bot.user.name, icon_url=self.bot.user.avatar)
            await ctx.send(embed=embed)
        ...
        for _ in banned_users:
            ...
            if (user.name, user, discriminator) == (name, discriminator):
                try:
                    ...
                    embed = discord.Embed(colour=discord.Colour.red())
                    embed.add_field(name=f'Error in unbanning {member}',
                                    value=f'You or I may not have the permission to unban {member}')
                    embed.set_author(name=self.bot.user.name, icon_url=self.bot.user.avatar)
                    await ctx.send(embed=embed)
                    return
    ...
    async def mute(self, ctx, member: discord.Member, *, reason='no reason'):
        ...
        try:
            ...
            embed = discord.Embed(colour=discord.Colour.red())
            embed.add_field(name=f'Error in muting {member}',
                            value=f'You or I may not have the permission to mute {member}')
            embed.set_author(name=self.bot.user.name, icon_url=self.bot.user.avatar)
            await ctx.send(embed=embed)
    ...
    async def unmute(self, ctx, member: discord.Member):
        ...
        try:
            ...
            embed = discord.Embed(colour=discord.Colour.red())
            embed.add_field(name=f'Error in unmuting {member}',
                            value=f'You or I may not have the permission to unmute {member}')
            embed.set_author(name=self.bot.user.name, icon_url=self.bot.user.avatar)
            await ctx.send(embed=embed)
